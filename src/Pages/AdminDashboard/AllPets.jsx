...
const AllPets = () => {
  ...
  const TABLE_HEAD = ["Pet image", "Pet name", "Location", "Adopted", " ", " "];
        ...
        <Card className="h-full w-full">
          ...
          <CardBody className="px-0">
            <table className="w-full min-w-max table-auto text-left">
              ...
              <tbody>
                {TABLE_ROWS.map(
                  ({ _id, petImage, petname, location, adopted }, index) => {
                      ...
                      <tr key={name}>
                        ...
                        <td className={classes}>
                          <Tooltip content="Edit">
                            <Link
                              to={`/dashboard/petUpdate/${_id}`}
                              className="bg-red-600 text-white text-center block py-1"
                            >
                              Edit
                            </Link>
                          </Tooltip>
